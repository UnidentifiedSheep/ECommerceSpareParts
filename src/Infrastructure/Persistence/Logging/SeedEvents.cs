...
public static class SeedEvents
{
	...
	public static readonly Action<ILogger, string, Exception?> NoSeedsFound = LoggerMessage.Define<string>(
		LogLevel.Information,
		NoSeedsFoundEventId,
		"No seeds found for {ContextName}");

	public static readonly Action<ILogger, string, Exception?> SeedStarted = LoggerMessage.Define<string>(
		LogLevel.Information,
		SeedStartedEventId,
		"Seeding started for {ContextName}");

	public static readonly Action<ILogger, string, Exception?> SeedCompleted = LoggerMessage.Define<string>(
		LogLevel.Information,
