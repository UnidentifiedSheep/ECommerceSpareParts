...
public class OrganizationTests
{
	...
	public void CreateIndividual_WithValidData_CreatesOrganizationWithOwner()
	{
		...
		var organization = OrganizationDomain.CreateIndividual("  Test organization  ", ownerId);
	...
	public void CreateBusiness_WithValidData_CreatesOrganizationWithOwner()
	{
		...
		organization
			...
			.Should()
			.ContainSingle(x =>
				x.UserId == ownerId && x.OrganizationId == organization.Id &&
	...
	public void CreateSystem_UsesConfiguredIdAndSystemOwner()
	{
		...
		organization
			...
			.Should()
			.ContainSingle(x =>
				x.UserId == systemId && x.OrganizationId == systemId && x.Role == OrganizationRole.Owner);
	}
	...
	{
		var action = () => OrganizationDomain.CreateIndividual(name, Guid.NewGuid());
	...
	{
		var action = () => OrganizationDomain.CreateIndividual(new string('a', 129), Guid.NewGuid());
	...
	[InlineData("")]
	[InlineData("   ")]
	public void CreateBusiness_WithoutSystemName_ThrowsInvalidInputException(string systemName)
	{
	...
	public void AddMember_ToBusinessOrganization_AddsMember()
	{
		...
		organization
			...
			.Should()
			.ContainSingle(x =>
				x.UserId == userId && x.OrganizationId == organization.Id &&
	...
	public void AddMember_WithSecondOwner_ThrowsInvalidInputException()
	{
		...
		var action = () => organization.AddMember(Guid.NewGuid(), OrganizationRole.Owner);
	...
	public void AddMember_ToIndividualOrganization_ThrowsInvalidInputException(OrganizationRole role)
	{
		var organization = OrganizationDomain.CreateIndividual("Individual organization", Guid.NewGuid());
	...
	public void ChangeMemberRole_WithExistingMember_ChangesRole()
	{
		...
		organization.Members.Single(x => x.UserId == memberId).Role.Should().Be(OrganizationRole.Admin);
	}
	...
	public void ChangeMemberRole_WithSameRole_DoesNothing()
	{
		...
		organization.Members.Single(x => x.UserId == memberId).Role.Should().Be(OrganizationRole.Manager);
	}
	...
	public void ChangeMemberRole_WithUnknownUser_ThrowsInvalidInputException()
	{
		...
		var action = () => organization.ChangeMemberRole(Guid.NewGuid(), OrganizationRole.Admin);
	...
	public void ChangeMemberRole_ForOwner_ThrowsInvalidInputException()
	{
		...
		var action = () => organization.ChangeMemberRole(ownerId, OrganizationRole.Admin);
	...
	public void ChangeMemberRole_ToOwner_ThrowsInvalidInputException()
	{
		...
		var action = () => organization.ChangeMemberRole(memberId, OrganizationRole.Owner);
