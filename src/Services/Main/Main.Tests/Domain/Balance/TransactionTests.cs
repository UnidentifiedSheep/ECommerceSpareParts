...
public class TransactionTests
{
	...
	public void ApplyProfile_SenderProfileMismatch_Throws()
	{
		...
		act.Should().Throw<InvalidOperationException>().WithMessage("Sender profile organization mismatch");
	}
	...
	public void ApplyProfile_CompletionProfileAppliedTwice_Throws()
	{
		...
		act.Should().Throw<InvalidOperationException>().WithMessage("Completion profile already applied");
	}
	...
	public void Apply_WithoutCompletionOrReverse_Throws()
	{
		...
		act.Should().Throw<InvalidOperationException>().WithMessage("Nothing to apply");
	}
	...
	public void Apply_ReversalAppliedTwice_Throws()
	{
		...
		act.Should().Throw<InvalidOperationException>().WithMessage("Reversed already applied.");
	}
	...
	public void Apply_CompletedTwice_Throws()
	{
		...
		act.Should().Throw<InvalidOperationException>().WithMessage("Completion already applied.");
	}
