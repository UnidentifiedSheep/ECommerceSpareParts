...
public sealed class ProducerImportLrtTests
    : CsvLrtIntegrationTest<ProducerImportLrt>
{
    public ProducerImportLrtTests(CombinedContainerFixture fixture)
        : base(fixture)
    {
    ...
    public async Task ExistingAndDuplicateNames_AreSkipped_AndValidProducerIsCreated()
    {
        ...
        var execution = await ExecuteCsv(
            ...
            fileName => new ProducerImportInputState { FileName = fileName });
        ...
        var created = await Context.Producers
            .AsNoTracking()
