...
public sealed class
	MapCatalogueCandidatesToProductsLrtTests : LrtIntegrationTest<MapCatalogueCandidatesToProductsLrt>
{
	public MapCatalogueCandidatesToProductsLrtTests(CombinedContainerFixture fixture) : base(fixture)
	{
