...
public sealed class ProductCrossesImportLrtTests
    : CsvLrtIntegrationTest<ProductCrossesImportLrt>
{
    public ProductCrossesImportLrtTests(CombinedContainerFixture fixture)
        : base(fixture)
    {
    ...
    public async Task ReverseDuplicate_IsSkipped_AndSingleCrossIsUpserted()
    {
        ...
        var execution = await ExecuteCsv(
            ...
            fileName => new ProductCrossesImportInputState { FileName = fileName });
