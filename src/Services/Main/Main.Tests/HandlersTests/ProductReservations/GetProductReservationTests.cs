...
{
	public GetProductReservationTests(CombinedContainerFixture fixture) : base(fixture)
	{
		RegisterBasicContext<ProductReservationTestContext>();
	}

	private ProductReservationTestContext TestContext => GetContext<ProductReservationTestContext>();
	...
	{
		var act = () => Mediator.Send(new GetProductReservationQuery(int.MaxValue));
