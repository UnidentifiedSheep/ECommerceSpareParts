...
public class Role : AuditableEntity<Role, string>, ILinqEntity<Role, string>
{
	...
	public static Expression<Func<Role, string>> GetKeySelector() => x => x.Name;
	...
	{
		Description = description.NullIfWhiteSpace()?.EnsureMaxLength(255, RoleDescriptionMaxLengthMessage.Instance);
	}
