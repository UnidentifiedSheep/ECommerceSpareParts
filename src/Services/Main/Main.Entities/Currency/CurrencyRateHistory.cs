	...
	ILinqEntity<CurrencyRateHistory, int>
{
	...
	public static Expression<Func<CurrencyRateHistory, int>> GetKeySelector() => x => x.Id;

	public static Expression<Func<CurrencyRateHistory, bool>> GetEqualityExpression(int key) => x =>
		x.Id == key;
