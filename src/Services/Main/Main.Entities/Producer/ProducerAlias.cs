...
public class ProducerAlias : Entity<ProducerAlias, string>, ILinqEntity<ProducerAlias, string>
{
	private ProducerAlias()
	{
	}

	private ProducerAlias(int producerId, string otherName)
	{
	...
	public static Expression<Func<ProducerAlias, string>> GetKeySelector() => x => x.Alias;
	...
	public override string GetId() => Alias;
}
