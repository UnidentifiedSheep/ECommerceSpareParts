...
public class SupplierProductName : Entity<SupplierProductName, int>, ILinqEntity<SupplierProductName, int>
{
	private SupplierProductName()
	{
	}

	private SupplierProductName(int supplierProductId, string name)
	{
	...
	public static Expression<Func<SupplierProductName, int>> GetKeySelector() => x => x.Id;
