...
public static class ProductEnrichmentEndPoints
{
    public static RouteGroupBuilder MapProductEnrichmentEndPoints(this RouteGroupBuilder products)
    {
        products.MapGet(
                ...
                async (
                    ISender sender,
                    [AsParameters] GetCatalogueCandidatesForReviewRequest request,
            ...
            .WithDescription("Получение кандидатов каталога вместе с сопоставленными товарами и исходными товарами поставщиков")
