...
{
	public static RouteGroupBuilder MapOrganizationMemberEndPoints(this RouteGroupBuilder organizations)
	{
		organizations
			.MapGet(
				...
				async (
					...
					[AsParameters] PaginationQueryModel pagination, CancellationToken cancellationToken) =>
				{
		...
		organizations
			.MapPost(
				...
				async (
					ISender sender, Guid organizationId,
					AddOrganizationMemberRequest request, CancellationToken cancellationToken) =>
				{
					await sender.Send(
		...
		organizations
			.MapPatch(
				...
				async (
					ISender sender, Guid organizationId,
					Guid userId, ChangeOrganizationMemberRoleRequest request,
