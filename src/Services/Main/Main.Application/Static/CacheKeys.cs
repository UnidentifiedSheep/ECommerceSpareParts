...
public static class CacheKeys
{
    public static class ProductCache
    {
        ...
        public static string ProductSizes(int id) { return $"product:{id}:sizes"; }

        public static string ProductWeight(int id) { return $"product:{id}:weight"; }
    }
    ...
    public static class UserCache
    {
        ...
        public static string User(Guid userId) { return $"user:{userId}"; }

        public static string UserDiscount(Guid userId) { return $"user:{userId}:discount"; }
        ...
        public static string RolesAndPermissionsRelations() { return "users:roles:permissions:relations"; }
    }
    ...
    public static class CurrencyCache
    {
        ...
        public static string Currency(int currencyId) { return $"currency:{currencyId}"; }
    ...
    {
        public static string OneTimeToken(Guid tokenId) => $"password-reset:{tokenId}";
    }
}