...
{
    public async Task<GetOrganizationResult> Handle(GetOrganizationQuery request, CancellationToken cancellationToken)
    {
        ...
        if (org != null) return new GetOrganizationResult(org);
