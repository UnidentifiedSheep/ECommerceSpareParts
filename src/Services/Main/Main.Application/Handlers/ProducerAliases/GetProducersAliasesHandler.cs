...
public record GetProducersAliasesResult(Dictionary<int, List<string>> ProducersAliases);

public class GetProducersAliasesHandler(IReadRepository<ProducerAlias, string> repository)
