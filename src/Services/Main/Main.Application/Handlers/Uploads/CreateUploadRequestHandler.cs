...
public record CreateUploadRequestCommand(string FileName, string ContentType) : ICommand<CreateUploadRequestResult>;
public record CreateUploadRequestResult(string UploadUrl);

public class CreateUploadRequestHandler(
    IS3StorageService storageService) : ICommandHandler<CreateUploadRequestCommand, CreateUploadRequestResult>
{
