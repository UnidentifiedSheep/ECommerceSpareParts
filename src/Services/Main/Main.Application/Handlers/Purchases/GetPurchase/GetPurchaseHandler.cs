...
public record GetPurchaseQuery(Guid? PurchaseId, Guid? TransactionId) : IQuery<GetPurchaseResult>;
...
{
	public async Task<GetPurchaseResult> Handle(GetPurchaseQuery request, CancellationToken cancellationToken)
	{
