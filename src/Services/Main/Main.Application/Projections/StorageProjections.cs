...
public sealed class StorageRouteDtoProjectionProvider : ProjectionProviderBase<StorageRoute, StorageRouteDto>
{
	public StorageRouteDtoProjectionProvider(IProjectionProvider<Currency, CurrencyDto> currencyProjection)
	{
...
[Lifetime(Lifetime.Singleton)]
public sealed class StorageDtoProjectionProvider : ProjectionProviderBase<Storage, StorageDto>
{
	public override Expression<Func<Storage, StorageDto>> Projection { get; } = x => new StorageDto
	{
		Code = x.Code,
		Location = x.Location,
