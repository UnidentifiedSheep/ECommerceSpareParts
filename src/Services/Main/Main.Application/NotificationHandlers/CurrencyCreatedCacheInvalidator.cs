...
public class CurrencyCreatedCacheInvalidator(
    IRelatedDataRepository<Currency> relatedDataBase,
    ICache cache,
    ICurrencyRepository currencyRepository) : INotificationHandler<CurrencyCreatedNotification>
{
    ...
    {
        var prevCurrency =
            await currencyRepository.GetCurrencyBeforeSpecifiedId(notification.Id, false, cancellationToken);
