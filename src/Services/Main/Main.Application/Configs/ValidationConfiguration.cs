...
public static class ValidationConfiguration
{
	...
	private static void ConfigureOrganization()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.OrganizationsNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Tuple,
			config => config
				.WithErrorName(ApplicationErrors.OrganizationMemberNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Tuple,
			config => config
				.WithErrorName(ApplicationErrors.OrganizationMemberAlreadyExists)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.OrganizationSystemNameAlreadyTaken)
	...
	private static void ConfigureStorageContents()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.StorageContentNotFound)
	...
	private static void ConfigureStorageOwners()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Tuple,
			config => config
				.WithErrorName(ApplicationErrors.StorageOwnerAlreadyExist)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Tuple,
			config => config
				.WithErrorName(ApplicationErrors.StorageOwnerNotFound)
	...
	private static void ConfigureStorageRoutes()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.StorageRouteNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Tuple,
			config => config
				.WithErrorName(ApplicationErrors.StorageRouteAlreadyExist)
	...
	private static void ConfigureCart()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Tuple,
			config => config
				.WithErrorName(ApplicationErrors.CartItemNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Tuple,
			config => config
				.WithErrorName(ApplicationErrors.CartItemAlreadyExist)
	...
	private static void ConfigureProducerAliases()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.ProducerAliasNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.ProducerAliasAlreadyTaken)
	...
	private static void ConfigureCurrency()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.CurrencyNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.CurrencyCodeAlreadyTaken)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.CurrencyNameAlreadyTaken)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.CurrencyShortNameAlreadyTaken)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.CurrencySignAlreadyTaken)
	...
	private static void ConfigurePermission()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.PermissionNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.PermissionAlreadyExists)
	...
	private static void ConfigureStorage()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.StoragesNotFound)
		...
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.StoragesCodeAlreadyTaken)
	...
	private static void ConfigureArticles()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.ArticlesNotFound)
	...
	private static void ConfigureProducer()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.ProducersNotFound)
	...
	private static void ConfigureUser()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.UsersNotFound)
	...
	private static void ConfigureTransaction()
	{
		ConfigureDbValidation.AddConfig(
			...
			KeyValueType.Single,
			config => config
				.WithErrorName(ApplicationErrors.TransactionsNotFound)
