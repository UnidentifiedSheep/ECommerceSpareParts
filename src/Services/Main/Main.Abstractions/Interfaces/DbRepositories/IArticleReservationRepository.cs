...
public interface IArticleReservationRepository
{
    ...
    Task<IEnumerable<StorageContentReservation>> GetReservationsByExecAsync(
        string? searchTerm,
        Guid? userId,
        int offset,
        int limit,
    ...
    Task<IEnumerable<StorageContentReservation>> GetReservationsBySimilarityAsync(
        string? searchTerm,
        Guid? userId,
        int offset,
        int limit,
    ...
    Task<IEnumerable<StorageContentReservation>> GetReservationsFromStartAsync(
        string? searchTerm,
        Guid? userId,
        int offset,
        int limit,
    ...
    Task<IEnumerable<StorageContentReservation>> GetReservationsContainsAsync(
        string? searchTerm,
        Guid? userId,
        int offset,
        int limit,
