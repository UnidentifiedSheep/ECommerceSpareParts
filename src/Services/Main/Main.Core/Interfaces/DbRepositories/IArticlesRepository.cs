...
public interface IArticlesRepository
{
    ...
    Task<List<Article>> GetArticlesCrosses(int articleId, int page = -1, int viewCount = -1,
        CancellationToken token = default);

    Task<IEnumerable<Article>> GetArticlesForUpdate(IEnumerable<int> articleIds, bool track = true,
