...
public class PurchaseLogisticConfiguration : IEntityTypeConfiguration<PurchaseLogistic>
{
	public void Configure(EntityTypeBuilder<PurchaseLogistic> builder)
	{
		...
		builder.HasIndex(e => e.TransactionId, "purchase_logistics_transaction_id_uindex").IsUnique();
		...
		builder.Property(e => e.MinimumPriceApplied).HasColumnName("minimum_price_applied");
		...
		builder
			.HasOne<Entities.Purchase.Purchase>()
