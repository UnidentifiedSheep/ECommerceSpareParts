...
public class PurchaseContentLogisticConfiguration : IEntityTypeConfiguration<PurchaseContentLogistic>
{
	public void Configure(EntityTypeBuilder<PurchaseContentLogistic> builder)
	{
		...
		builder.HasKey(e => e.PurchaseContentId).HasName("purchase_content_logistics_pk");

		builder.Property(e => e.PurchaseContentId).ValueGeneratedNever().HasColumnName("purchase_content_id");

		builder.Property(e => e.AreaM3).HasColumnName("area_m3");
