    ...
    IEntityTypeConfiguration<SupplierProductName>
{
    public void Configure(
        EntityTypeBuilder<SupplierProductName> builder)
    {
        builder.ToTable(
            "supplier_product_names",
        ...
        builder.Property(x => x.SupplierProductId)
        ...
        builder.HasIndex(x => new
            ...
            .HasDatabaseName(
                "supplier_product_names_product_name_uidx")
            .IsUnique();
        ...
        builder.HasOne(x => x.SupplierProduct)
            ...
            .HasConstraintName(
                "supplier_product_names_supplier_product_id_fk");
    }
}
