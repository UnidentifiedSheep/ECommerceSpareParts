...
public class SupplierProductConfiguration :
    IEntityTypeConfiguration<SupplierProduct>
{
    public void Configure(
        EntityTypeBuilder<SupplierProduct> builder)
    {
        builder.ToTable(
            "supplier_products",
        ...
        builder.ComplexProperty(
            ...
            sku =>
            {
                ...
                sku.Property(x => x.NormalizedValue)
                    ...
                    .IsRequired()
                    .HasComplexIndex(
                        indexName: "supplier_products_normalized_sku_idx");
            });
        ...
        builder.Property(x => x.CatalogueCandidateId)
            .HasColumnName("catalogue_candidate_id");

        builder.HasOne(x => x.CatalogueCandidate)
            .WithMany(x => x.SupplierProducts)
            .HasForeignKey(x => x.CatalogueCandidateId)
            .OnDelete(DeleteBehavior.SetNull)
            .HasConstraintName(
                "supplier_products_catalogue_candidate_id_fk");
        ...
        builder.HasIndex(x => x.CatalogueCandidateId)
            .HasDatabaseName(
                "supplier_products_catalogue_candidate_id_idx");
    }
}
