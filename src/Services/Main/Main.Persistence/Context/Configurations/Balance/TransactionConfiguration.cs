...
public class TransactionConfiguration : IEntityTypeConfiguration<Transaction>
{
	public void Configure(EntityTypeBuilder<Transaction> builder)
	{
		...
		builder.HasKey(e => e.Id).HasName("transactions_pk");
		...
		builder.HasIndex(
			...
			"transactions_sender_id_receiver_id_index");
		...
		builder.Property(e => e.Id).HasDefaultValueSql("uuidv7()").HasColumnName("id").ValueGeneratedOnAdd();
		...
		builder.Property(e => e.Type).HasMaxLength(28).HasColumnName("type");

		builder.Property(e => e.Status).HasConversion<long>().HasColumnName("status");

		builder.Property(e => e.TransactionDatetime).HasColumnName("transaction_datetime");
		...
		builder
			.HasOne<Entities.Organization.Organization>(x => x.Receiver)
			.WithMany()
		...
		builder
			.HasOne<Entities.Organization.Organization>(x => x.Sender)
			.WithMany()
