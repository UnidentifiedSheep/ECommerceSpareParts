...
public class ProducerSupplierMappingConfiguration : IEntityTypeConfiguration<ProducerSupplierMapping>
{
	public void Configure(EntityTypeBuilder<ProducerSupplierMapping> builder)
	{
		...
		builder.HasKey(e => e.Id).HasName("producer_supplier_mappings_pk");

		builder.Property(e => e.Id).HasColumnName("id");

		builder.Property(e => e.Supplier).HasColumnName("supplier").HasMaxLength(32);

		builder.Property(e => e.ProducerId).HasColumnName("producer_id");

		builder
			.Property(e => e.SupplierProducerName)
		...
		builder
			...
			{
				e.SupplierProducerName, e.Supplier
			})
