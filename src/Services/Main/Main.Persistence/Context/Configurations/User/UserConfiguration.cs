...
public class UserConfiguration : IEntityTypeConfiguration<Entities.User.User>
{
	public void Configure(EntityTypeBuilder<Entities.User.User> builder)
	{
		...
		builder.ComplexProperty(
			...
			b =>
			{
				b.Property(e => e.Value).HasMaxLength(36).HasColumnName("user_name");
		...
		builder.Navigation(e => e.Phones).HasField("_phones").UsePropertyAccessMode(PropertyAccessMode.Field);

		builder.Navigation(e => e.Roles).HasField("_roles").UsePropertyAccessMode(PropertyAccessMode.Field);
