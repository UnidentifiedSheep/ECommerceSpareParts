...
public class UserPhoneConfiguration : IEntityTypeConfiguration<UserPhone>
{
	public void Configure(EntityTypeBuilder<UserPhone> builder)
	{
		...
		builder.HasKey(e => e.NormalizedPhone).HasName("user_phones_pk");

		builder
			.HasIndex(e => e.NormalizedPhone, "user_phones_normalized_phone_index")
			.HasMethod("gin")
		...
		builder
			.HasIndex(
				e => new
				{
					e.UserId, e.IsPrimary
				},
				"user_phones_user_id_is_primary_uindex")
			.IsUnique()
		...
		builder.Property(e => e.NormalizedPhone).HasMaxLength(32).HasColumnName("normalized_phone");

		builder.Property(e => e.PhoneNumber).HasMaxLength(32).HasColumnName("phone_number");

		builder.Property(e => e.PhoneType).HasMaxLength(32).HasColumnName("phone_type");
