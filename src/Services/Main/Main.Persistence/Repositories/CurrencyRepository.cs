...
public class CurrencyRepository(DContext context) : ICurrencyRepository
{
    ...
    public async Task<Currency?> GetCurrencyById(
        int id,
        bool track = true,
    ...
    public async Task<IEnumerable<Currency>> GetCurrencies(
        ...
        bool track = true,
        CancellationToken cancellationToken = default,
        params Expression<Func<Currency, object?>>[] includes)
    {
    ...
    public async Task<Currency?> GetCurrencyBeforeSpecifiedId(
        int id,
        bool track = true,
        CancellationToken cancellationToken = default)
    {
