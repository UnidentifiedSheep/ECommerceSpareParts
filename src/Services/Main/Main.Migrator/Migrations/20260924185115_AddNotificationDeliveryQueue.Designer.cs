...
namespace Main.Migrator.Migrations
{
    ...
    [Migration("20260924185115_AddNotificationDeliveryQueue")]
    partial class AddNotificationDeliveryQueue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Main.Entities.Balance.OrganizationBalance", b =>
                {
                    ...
                    b.HasIndex("WhoCreated")
                        .HasDatabaseName("main.entities.balance.organizationbalance_who_created_idx");

                    b.HasIndex("WhoUpdated")
                        .HasDatabaseName("main.entities.balance.organizationbalance_who_updated_idx");

                    b.HasIndex("CurrencyId", "OrganizationId")
                        .IsUnique()
                        .HasDatabaseName("organization_balances_currency_id_user_id_uindex");

                    b.ToTable("organization_balances", "public");
                });
            ...
            modelBuilder.Entity("Main.Entities.Organization.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WhoCreated")
                        .HasDatabaseName("main.entities.organization.organization_who_created_idx");

                    b.HasIndex("WhoUpdated")
                        .HasDatabaseName("main.entities.organization.organization_who_updated_idx");

                    b.ToTable("organizations", "auth");
                });

            modelBuilder.Entity("Main.Entities.Organization.OrganizationFinancialProfile", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid")
                        .HasColumnName("organization_id");

                    b.Property<decimal>("ApproximateBalance")
                        .HasColumnType("numeric")
                    ...
                    b.HasIndex("WhoCreated")
                        .HasDatabaseName("main.entities.organization.organizationfinancialprofile_who_created_idx");

                    b.HasIndex("WhoUpdated")
                        .HasDatabaseName("main.entities.organization.organizationfinancialprofile_who_updated_idx");

                    b.ToTable("organization_financial_profile", "public");
                });

            modelBuilder.Entity("Main.Entities.Organization.OrganizationMember", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid")
                        .HasColumnName("organization_id");
                    ...
                    b.HasIndex("WhoCreated")
                        .HasDatabaseName("main.entities.organization.organizationmember_who_created_idx");

                    b.HasIndex("WhoUpdated")
                        .HasDatabaseName("main.entities.organization.organizationmember_who_updated_idx");
                    ...
                    b.ToTable("organization_members", "auth");
                });
            ...
            modelBuilder.Entity("Main.Entities.Producer.ProducerSupplierMapping", b =>
                {
                    ...
                    b.HasAlternateKey("SupplierProducerName", "Supplier")
            ...
            modelBuilder.Entity("Main.Entities.Product.Enrichment.CatalogueCandidate", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Sku", "Main.Entities.Product.Enrichment.CatalogueCandidate.Sku#Sku", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasIndex("WhoCreated")
                        .HasDatabaseName("main.entities.product.enrichment.cataloguecandidate_who_created_idx");

                    b.HasIndex("WhoUpdated")
                        .HasDatabaseName("main.entities.product.enrichment.cataloguecandidate_who_updated_idx");

                    b.ToTable("catalogue_candidates", "catalogue_enrichment");

                    b.HasAnnotation("CustomIndex:CompositeIndexes", "[{\"paths\":[\"Sku.NormalizedValue\",\"ProducerId\"],\"unique\":true,\"name\":\"catalogue_candidates_sku_producer_uidx\"}]");
                });
            ...
            modelBuilder.Entity("Main.Entities.Product.Enrichment.SupplierProduct", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Sku", "Main.Entities.Product.Enrichment.SupplierProduct.Sku#Sku", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.Property<string>("NormalizedValue")
                                ...
                                .HasAnnotation("CustomIndex:Name", "supplier_products_normalized_sku_idx");
                    ...
                    b.HasIndex("CatalogueCandidateId")
                        .HasDatabaseName("supplier_products_catalogue_candidate_id_idx");

                    b.HasIndex("WhoCreated")
                        .HasDatabaseName("main.entities.product.enrichment.supplierproduct_who_created_idx");

                    b.HasIndex("WhoUpdated")
                        .HasDatabaseName("main.entities.product.enrichment.supplierproduct_who_updated_idx");

                    b.ToTable("supplier_products", "catalogue_enrichment");

                    b.HasAnnotation("CustomIndex:CompositeIndexes", "[{\"paths\":[\"Supplier\",\"Producer\",\"Sku.NormalizedValue\"],\"unique\":true,\"name\":\"supplier_products_supplier_producer_sku_uidx\"}]");
                });

            modelBuilder.Entity("Main.Entities.Product.Enrichment.SupplierProductCross", b =>
                {
                    ...
                    b.HasIndex("RightId")
                        .HasDatabaseName("supplier_product_crosses_right_product_id_idx");

                    b.ToTable("supplier_product_crosses", "catalogue_enrichment");
                });

            modelBuilder.Entity("Main.Entities.Product.Enrichment.SupplierProductName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("supplier_product_names", "catalogue_enrichment");
                });
            ...
            modelBuilder.Entity("Main.Entities.Purchase.Purchase", b =>
                {
                    ...
                    b.HasIndex(new[] { "SupplierOrganizationId" }, "purchase_supplier_organization_id_index");

                    b.HasIndex(new[] { "SupplierUserId" }, "purchase_supplier_user_id_index");
            ...
            modelBuilder.Entity("Main.Entities.Sale.Sale", b =>
                {
                    ...
                    b.HasIndex(new[] { "OrganizationId" }, "sale_organization_id_index");

                    b.HasIndex(new[] { "SaleDatetime" }, "sale_sale_datetime_index");

                    b.HasIndex(new[] { "State" }, "sale_state_index");

                    b.HasIndex(new[] { "StorageCode" }, "sale_storage_name_index");

                    b.HasIndex(new[] { "TransactionId" }, "sale_transaction_id_index");

                    b.HasIndex(new[] { "UserId" }, "sale_user_id_index");
            ...
            modelBuilder.Entity("Main.Entities.Sale.SaleContent", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId", "SaleId" }, "sale_content_product_id_sale_id_index");
            ...
            modelBuilder.Entity("Main.Entities.Storage.ProductReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("WhoCreated")
                        .HasDatabaseName("main.entities.storage.productreservation_who_created_idx");

                    b.HasIndex("WhoUpdated")
                        .HasDatabaseName("main.entities.storage.productreservation_who_updated_idx");
                    ...
                    b.HasIndex(new[] { "OrganizationId", "Status" }, "storage_content_reservations_organization_id_status_index");
            ...
            modelBuilder.Entity("Main.Entities.Storage.StorageContent", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId", "StorageCode" }, "storage_content_product_id_storage_name_index");

                    b.HasIndex(new[] { "ProductId", "StorageCode" }, "storage_content_product_storage_positive_count_idx")
                        .HasFilter("(count > 0)");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex(new[] { "ProductId", "StorageCode" }, "storage_content_product_storage_positive_count_idx"), new[] { "Count" });

                    b.HasIndex(new[] { "StorageCode", "ProductId" }, "storage_content_storage_name_product_id_index");
            ...
            modelBuilder.Entity("Main.Entities.Storage.StorageRoute", b =>
                {
                    ...
                    b.HasIndex(new[] { "FromStorageCode", "ToStorageCode", "IsActive" }, "storage_from_to_active_uindex")
                        .IsUnique()
            ...
            modelBuilder.Entity("Main.Entities.Balance.OrganizationBalance", b =>
                {
                    ...
                    b.HasOne("Main.Entities.Organization.Organization", null)
                        .WithMany("Balances")
            ...
            modelBuilder.Entity("Main.Entities.Organization.OrganizationFinancialProfile", b =>
                {
                    b.HasOne("Main.Entities.Organization.Organization", null)
                        ...
                        .HasForeignKey("Main.Entities.Organization.OrganizationFinancialProfile", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("Main.Entities.Organization.OrganizationMember", b =>
                {
                    b.HasOne("Main.Entities.Organization.Organization", "Organization")
                        .WithMany("Members")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Main.Entities.Product.Enrichment.SupplierProduct", b =>
                {
                    b.HasOne("Main.Entities.Product.Enrichment.CatalogueCandidate", "CatalogueCandidate")
                        .WithMany("SupplierProducts")
                        .HasForeignKey("CatalogueCandidateId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("supplier_products_catalogue_candidate_id_fk");

                    b.Navigation("CatalogueCandidate");
                });

            modelBuilder.Entity("Main.Entities.Product.Enrichment.SupplierProductCross", b =>
                {
                    b.HasOne("Main.Entities.Product.Enrichment.SupplierProduct", "Left")
                        .WithMany()
                    ...
                    b.HasOne("Main.Entities.Product.Enrichment.SupplierProduct", "Right")
                        .WithMany()
            ...
            modelBuilder.Entity("Main.Entities.Product.Enrichment.SupplierProductName", b =>
                {
                    b.HasOne("Main.Entities.Product.Enrichment.SupplierProduct", "SupplierProduct")
                        .WithMany("Names")
            ...
            modelBuilder.Entity("Main.Entities.Purchase.Purchase", b =>
                {
                    ...
                    b.HasOne("Main.Entities.Organization.Organization", "SupplierOrganization")
                        .WithMany()
                    ...
                    b.HasOne("Main.Entities.User.User", "SupplierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Main.Entities.Sale.SaleContent", b =>
                {
                    ...
                    b.HasOne("Main.Entities.Sale.Sale", "Sale")
                        .WithMany("Contents")
            ...
            modelBuilder.Entity("Main.Entities.Event.ReservationManualChangeEvent", b =>
                {
                    b.HasOne("Main.Entities.Storage.ProductReservation", null)
                        .WithMany()
