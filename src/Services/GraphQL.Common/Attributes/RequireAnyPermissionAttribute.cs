...
public sealed class RequireAnyPermissionAttribute : RequireAuthorizationAttribute
{
	...
	public RequireAnyPermissionAttribute(params PermissionCodes[] permissions) : base(
		PolicyName,
		new PermissionRequirement(permissions, AuthorizationMatch.Any))
	{
	}
