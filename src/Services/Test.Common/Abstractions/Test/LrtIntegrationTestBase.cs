...
public abstract class
	LrtIntegrationTestBase<TLrt, TSp, TArgs, TContext> : IntegrationTestBase<TSp, TArgs, TContext>
	...
	where TContext : DbContext
{
	...
	{
		var lrt = ActivatorUtilities.CreateInstance<TLrt>(Scope.ServiceProvider);
		...
		var verificationContext = verificationScope.ServiceProvider.GetRequiredService<TContext>();
