...
public class JobScheduleTests
{
	...
	{
		var schedule = Create();
		string name = new('a', JobSchedule.NameMaxLength + 1);
	...
	{
		var schedule = Create();
		string description = new('a', JobSchedule.DescriptionMaxLength + 1);
