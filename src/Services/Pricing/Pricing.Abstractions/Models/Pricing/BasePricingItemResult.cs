...
/// <param name="AppliedCoefficients">
///     The collection of <see cref="PriceCoefficient" /> objects that were applied
///     to calculate the final price.
/// </param>
public record BasePricingItemResult(
    int Id,
    decimal BasePrice,
    decimal FinalPrice,
    IEnumerable<PriceCoefficient> AppliedCoefficients);