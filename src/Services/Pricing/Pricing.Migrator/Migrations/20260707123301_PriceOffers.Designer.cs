...
namespace Pricing.Migrator.Migrations
{
    ...
    [Migration("20260707123301_PriceOffers")]
    partial class PriceOffers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pricing.Entities.PriceOffer", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "price_offer_product_id_index");

                    b.HasIndex(new[] { "Source", "SourceKey" }, "price_offer_source_source_key_index")
                        .IsUnique();
