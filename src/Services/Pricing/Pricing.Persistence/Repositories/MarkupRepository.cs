...
{
    public async Task<MarkupGroup?> GetGeneratedMarkupsAsync(
        bool track = true,
    ...
    public async Task<MarkupGroup?> GetMarkupByIdAsync(
        int id,
        bool track = true,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IEnumerable<MarkupGroup>> GetMarkupGroups(
        int page,
        int viewCound,
        bool track = true,
        CancellationToken cancellationToken = default)
    ...
    public async Task<IEnumerable<MarkupRange>> GetMarkupRanges(
        int markupId,
        bool track = true,
        CancellationToken cancellationToken = default)
    {
