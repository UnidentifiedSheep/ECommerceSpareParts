...
public class ProductPriceOptionConfiguration : IEntityTypeConfiguration<ProductPriceOption>
{
	public void Configure(EntityTypeBuilder<ProductPriceOption> builder)
	{
		...
		builder.HasKey(e => e.PriceOfferId).HasName("product_price_option_pk");
		...
		builder.Property(e => e.PriceOfferId).HasColumnName("price_offer_id");
		...
		builder.Property(x => x.MarkupVersion).HasColumnName("markup_version");

		builder.Property(x => x.AppliersVersion).HasColumnName("appliers_version");

		builder.Property(x => x.PricingSettingsVersion).HasColumnName("pricing_settings_version");

		builder.Property(e => e.Markup).HasColumnName("markup");

		builder.Property(e => e.ForStorageCode).HasMaxLength(128).HasColumnName("for_storage_name");

		builder.Property(e => e.DeliveryTime).HasColumnName("delivery_time");

		builder.Property(e => e.GuaranteedDeliveryTime).HasColumnName("guaranteed_delivery_time");

		builder.Property(e => e.DeliveryProbability).HasColumnName("delivery_probability");

		builder
			.HasOne(e => e.PriceOffer)
			.WithOne()
