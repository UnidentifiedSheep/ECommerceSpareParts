...
public interface ICache
{
	...
	Task SetAsync<T>(IEnumerable<(string key, T value)> keyValues, TimeSpan? ttl = null);
	...
	Task<bool> SetExpireAsync(string key, TimeSpan? ttl = null);

	Task<Dictionary<string, bool>> SetExpireAsync(IEnumerable<string> keys, TimeSpan? ttl = null);
	...
	Task AddToSetAsync(Dictionary<string, List<string>> keyValues, TimeSpan? ttl = null);
