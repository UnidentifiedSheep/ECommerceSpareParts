...
public abstract class SettingDefinitionNamedObjectBase<TSetting>(ISettingsService settingsService)
	: SettingDefinitionNamedObjectBase where TSetting : Setting, ISetting<TSetting>
{
...
public abstract class SettingDefinitionNamedObjectBase : LocalizableNameObject
{
	...
	public abstract Task UpdateSettingAsync(string json, CancellationToken cancellationToken);
