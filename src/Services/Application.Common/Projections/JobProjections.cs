...
public sealed class JobDtoProjectionProvider : ProjectionProviderBase<Job, JobDto>
{
	public override Expression<Func<Job, JobDto>> Projection { get; } = job => new JobDto
	{
