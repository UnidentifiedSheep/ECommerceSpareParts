...
public partial class EmailValidator : IEmailValidator
{
	public bool IsValidEmail(string source)
	{
		...
		if (local.Contains("..", StringComparison.InvariantCulture) ||
			domain.Contains("..", StringComparison.InvariantCulture))
			return false;

		if (!domain.Contains('.', StringComparison.InvariantCulture))
			return false;
