...
public class JobScheduleRunConfiguration : IEntityTypeConfiguration<JobScheduleRun>
{
	public void Configure(EntityTypeBuilder<JobScheduleRun> builder)
	{
		...
		builder.HasKey(e => e.Id).HasName("job_schedule_runs_pk");

		builder.Property(e => e.Id).HasColumnName("id").ValueGeneratedOnAdd();

		builder.Property(e => e.JobScheduleId).HasColumnName("job_schedule_id");

		builder.Property(e => e.JobId).HasColumnName("job_id");

		builder.Property(e => e.ScheduledAt).HasColumnName("scheduled_at");

		builder.Property(e => e.QueuedAt).HasColumnName("queued_at");

		builder
			.HasIndex(
				e => new
				{
					e.JobScheduleId, e.ScheduledAt
				},
				"job_schedule_runs_job_schedule_id_scheduled_at_idx")
			.IsUnique();

		builder.HasIndex(e => e.JobId, "job_schedule_runs_job_id_idx").IsUnique();
