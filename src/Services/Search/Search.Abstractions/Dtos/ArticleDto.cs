...
public partial class ArticleDto
{
    ...
    [StringLength(128, MinimumLength = 3,
        ErrorMessage = "Минимальная длина артикула 3 символа, максимальная 128 символов.")]
    public string ArticleNumber { get; set; } = null!;

    [Sanitize(Trim = true)]
    [Required(ErrorMessage = "Название обязательно.")]
    [StringLength(256, MinimumLength = 3,
        ErrorMessage = "Минимальная длина названия 3 символа, максимальная 256 символов.")]
    ...
    [StringLength(128, MinimumLength = 3,
        ErrorMessage = "Минимальная длина названия производителя 3 символа, максимальная 128 символов.")]
