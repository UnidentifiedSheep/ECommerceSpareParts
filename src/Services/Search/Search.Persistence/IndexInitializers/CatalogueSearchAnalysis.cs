...
internal static class CatalogueSearchAnalysis
{
    ...
    internal static AnalysisDescriptor ConfigureCatalogueSearch(
        this AnalysisDescriptor analysis)
    {
        return analysis
            ...
            .Analyzers(analyzers => analyzers
                ...
                .Custom(
                    PrefixAnalyzer,
                    analyzer => analyzer
                        .Tokenizer("catalogue_prefix_tokenizer")
                        .Filters("lowercase"))
                .Custom(
                    ContainsAnalyzer,
                    analyzer => analyzer
                        .Tokenizer("catalogue_contains_tokenizer")
                        .Filters("lowercase")));
    }
