...
public class MainProductSearchDocumentProvider(IMainClient mainClient) : IProductSearchDocumentProvider
{
		...
		CancellationToken cancellationToken = default)
	{
		...
		if (!response.Success)
			throw new InvalidOperationException(
				$"Unable to get products from Main service. " + $"Status: {response.StatusCode}. " +
