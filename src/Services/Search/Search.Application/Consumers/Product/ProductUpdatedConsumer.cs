...
public class ProductUpdatedConsumer(IIndexSynchronizer<Entities.Product, int> productIndexSynchronizer)
...
public class ProductUpdatedConsumerDefinition : ConsumerDefinition<ProductUpdatedConsumer>
{
