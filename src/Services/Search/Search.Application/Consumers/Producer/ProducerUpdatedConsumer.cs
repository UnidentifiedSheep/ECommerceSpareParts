...
public class ProducerUpdatedConsumer(IIndexSynchronizer<Entities.Producer, int> producerIndexSynchronizer)
...
public class ProducerUpdatedConsumerDefinition : ConsumerDefinition<ProducerUpdatedConsumer>
{
