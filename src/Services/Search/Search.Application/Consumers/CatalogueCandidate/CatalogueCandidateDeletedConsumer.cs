...
public sealed class CatalogueCandidateDeletedConsumer(
    ISender sender)
    : IConsumer<Batch<CatalogueCandidateDeletedEvent>>
{
    public Task Consume(
        ConsumeContext<Batch<CatalogueCandidateDeletedEvent>> context)
    {
        return sender.Send(
            new DeleteCatalogueCandidatesCommand(
                context.Message
...
public sealed class CatalogueCandidateDeletedConsumerDefinition
    : ConsumerDefinition<CatalogueCandidateDeletedConsumer>
{
