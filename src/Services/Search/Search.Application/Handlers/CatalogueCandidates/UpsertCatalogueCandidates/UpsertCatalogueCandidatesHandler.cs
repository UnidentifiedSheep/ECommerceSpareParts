...
public sealed record UpsertCatalogueCandidatesCommand(
	IReadOnlyCollection<CatalogueCandidateUpdatedEvent> Events) : ICommand;

public sealed class UpsertCatalogueCandidatesHandler(ICatalogueCandidateRepository repository)
	: ICommandHandler<UpsertCatalogueCandidatesCommand>
{
	...
	private static CatalogueCandidateDocument MapDocument(CatalogueCandidateUpdatedEvent @event)
	{
