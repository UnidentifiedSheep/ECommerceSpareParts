...
public static class ArticlesEndPoints
{
    ...
    private static async Task<IResult> SearchArticles(
        ...
        string? cursor,
        int limit,
        ArticleSearchVariant searchVariant,
        IMediator mediator,
        CancellationToken cancellationToken)
    {
        var q = new SearchArticlesQuery(query, cursor, limit, searchVariant);
    ...
    private static async Task<IResult> GetArticleById(int id, IMediator mediator, CancellationToken cancellationToken)
    {
    ...
    private static async Task<IResult> AddArticle(
