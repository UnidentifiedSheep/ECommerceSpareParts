...
public interface IBuySellPriceRepository
{
    ...
    IAsyncEnumerable<BuySellPrice> GetBuySellPrices(Expression<Func<BuySellPrice, bool>>? where = null,
        bool track = true, CancellationToken cancellationToken = default);

    Task<List<BuySellPrice>> GetBuySellPricesAsList(Expression<Func<BuySellPrice, bool>>? where = null,
        bool track = true, CancellationToken cancellationToken = default);
