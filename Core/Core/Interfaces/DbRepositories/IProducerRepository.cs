...
public interface IProducerRepository
{
    ...
    Task<bool> OtherNameIsTaken(string otherName, int? producerId = null, string? whereUsed = null, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Producer>> GetProducers(string? searchTerm, int page, int viewCount, bool track = true, CancellationToken cancellationToken = default);
    Task<IEnumerable<ProducersOtherName>> GetOtherNames(int producerId, int page, int viewCount, bool track = true, CancellationToken cancellationToken = default);
}