...
public class GetUserDiscountHandler(IRedisUserRepository cacheUserRepository, IUsersRepository usersRepository) : IQueryHandler<GetUserDiscountQuery, GetUserDiscountResult>
{
