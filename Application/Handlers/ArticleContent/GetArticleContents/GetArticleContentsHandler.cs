...
namespace Application.Handlers.ArticleContent.GetArticleContents
{
	...
	public class GetArticleContentsHandler(IArticleContentRepository repository) : IQueryHandler<GetArticleContentsQuery, GetArticleContentsResult>
	{
		public async Task<GetArticleContentsResult> Handle(GetArticleContentsQuery request, CancellationToken cancellationToken)
		{
