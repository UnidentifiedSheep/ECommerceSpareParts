...
public class CreateProducerHandler(IUnitOfWork unitOfWork, IProducerRepository producerRepository) : ICommandHandler<CreateProducerCommand, CreateProducerResult>
{
