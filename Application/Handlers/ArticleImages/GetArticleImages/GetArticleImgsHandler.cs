...
namespace Application.Handlers.ArticleImages.GetArticleImages;
...
public class GetArticleImgsHandler(IArticleImageRepository imageRepository) : IQueryHandler<GetArticleImgsQuery, GetArticleImgsResult>
{
