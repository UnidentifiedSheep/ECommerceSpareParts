...
public class ArticlesRepository(DContext context) : IArticlesRepository
{
    ...
    public async Task<IEnumerable<Article>> GetArticleCrosses(int articleId, int page, int viewCount, string? sortBy, bool track = true,
    ...
    public async Task<List<Article>> GetArticlesByIds(IEnumerable<int> ids, bool track = true, CancellationToken token = default)
    {
        return await context.Articles.ConfigureTracking(track)
            .Include(x => x.Producer)
    ...
    public async Task<List<Article>> GetArticlesCrosses(int articleId, int page = -1, int viewCount = -1, CancellationToken token = default)
    {
    ...
    public async Task<IEnumerable<Article>> GetArticlesForUpdate(IEnumerable<int> articleIds, bool track = true, CancellationToken cancellationToken = default)
    {
        return await context.Articles
    ...
    public async Task AddArticleLinkage(IEnumerable<(int id, int crossId)> crossIds, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<int> UpdateArticlesCount(Dictionary<int, int> toIncrement, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IEnumerable<int>> ArticlesExistsAsync(IEnumerable<int> ids, CancellationToken cancellationToken = default)
    {
