...
public record CreateTransactionRequest(string SenderId, string ReceiverId, decimal Amount, int CurrencyId,
    string WhoCreatedTransaction, DateTime TransactionDateTime);
