using Application.Handlers.Markups.CreateMarkup;
using Carter;
...
public record CreateMarkupRequest(IEnumerable<NewMarkupRangeDto> Ranges, int CurrencyId, string? GroupName, decimal MarkupForUnknownRange); 
